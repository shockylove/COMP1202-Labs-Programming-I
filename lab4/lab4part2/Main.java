...
public class Main {
    public static void main(String[] args){
        ...
        System.out.println(z-1);//part1 finished

        //part2
        UserGroup myUserGroup = new UserGroup();
        myUserGroup.addSampleData();
        myUserGroup.printUsernames();//part2finished

    }


/**
 * add code to the main method which creates a new UserGroup
 Call addSampleData() on your UserGroup to populate it
 Call printUsernames() on the UserGroup to print out the Users.
**/
